-- Daily aggregated page views per listing (detail pages only, incremented server-side).

create table public.listing_view_daily (
...
create index listing_view_daily_view_date_idx on public.listing_view_daily (view_date);
